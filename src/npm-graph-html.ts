...
<div class="toolbar"><button id="expand-all" disabled>Expand all packages</button><button id="fit" disabled>Fit</button><button id="reset" disabled>Reset</button><button id="refresh">Refresh</button></div></header>
...
<p id="search-count"></p><div id="results" aria-label="Package search results"></div>
